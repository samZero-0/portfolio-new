...
// Galaxy — from React Bits (https://reactbits.dev), ported to TypeScript.
// Local changes: stable default props, pointer tracked on window (the canvas sits
// behind the hero content), ResizeObserver sizing, and rendering pauses off-screen.
...
export type GalaxyProps = React.HTMLAttributes<HTMLDivElement> & {
  focal?: [number, number];
...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    // Only render while the galaxy is on screen
  ...
  return <div ref={ctnDom} className={className ? `galaxy-container ${className}` : "galaxy-container"} {...rest} />;
}
